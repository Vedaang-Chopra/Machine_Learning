...
# Using Grid search technique to find the best possible c and gamma values for SVM algorit        hm
...
# Using Grid search technique to find the best possible neighbours value for KNN algorithm
clf = KNeighborsClassifier()
# using Grid Search on KNN to find the best possible neighbours value.
